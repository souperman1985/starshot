...
%
% This script calculates the acceleration distance for the sail film that we fabricated
% It uses the reflectivity measured by Caltech (this is The January 25, 2022 sample).
...
betaF = 0.2; % fraction of speed of light that we want to achieve
%Pwr0 = 30*(1e9/1); % GW-->W = kg-m2/s3 ... laser power
Pwr0 = 100*(1e9/1); % GW-->W = kg-m2/s3 ... laser power
Mtot = 2; % g ... total mass of sail, tethers, and chip
Msail = 1; % g ... mass of sail only
